...
import com.rish.microservices.order_service.client.InventoryClient;
...
public class OrderService {
    ...
    public void placeOrder(OrderRequest orderRequest){
        ...
        var isProductInStock = inventoryClient.inInStock(orderRequest.skuCode() , orderRequest.quantity());
